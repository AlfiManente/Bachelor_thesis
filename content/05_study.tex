...
Flavour tagging uncertainties are modelled using 55 nuisance parameters for $b$-tagging, 33 for $c$-tagging, and 42 for light-flavor jet tagging. 
...
\begin{figure}
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{Uncertainty for the renormalisation scale $\mu_{\rm{R}}$ for the $\ttbar$ background process.}
...
\begin{table}
    \centering
    \caption{Category-wise impact of systematic uncertainties on the fitted signal strength. Systematic uncertainties of this analysis are compared with the impacts in the previous measurement\,
