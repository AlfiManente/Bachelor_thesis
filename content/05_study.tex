...
For the training and validation datasets, the single top quark s-channel events were used as signal.
While the $\ttbar$ process, the single top quark t-channel and associated $tW$ production processes, as well as the $W$+jets and $Z$+jets processes constitute the background. 
