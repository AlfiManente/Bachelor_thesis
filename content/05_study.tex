...
The DNNs output is shown in the form of the separation plot in \autoref{subfig:separation} and the combined DNN output histograms of each respective process shown in \autoref{subfig:histos}. The event yields given out from the DNN are shown in \autoref{tab:yields}.
