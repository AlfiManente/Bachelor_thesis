...
Some alternative samples use a faster simulation procedure, where the \textsc{Geant4} simulation of the calorimeter response is replaced by a detailed parameterisation of the PS shapes\,\cite{fullsim}, in the following refferet to as \textit{fastsim}.
