...
Hadronic decay results into quark pairs, wheresas leptonic decay emits a lepton and its corresponding neutrino.
...
If the sum of all transverse momenta of all the outgoing particles, does not add to zero, then a particle has remained undetected and the event has missing transverse momentum $\etmiss$, as prior to the $pp$ collision both beam momenta should cancel out.
